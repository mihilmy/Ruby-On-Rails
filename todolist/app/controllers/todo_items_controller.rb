class TodoItemsController < ApplicationController
  before_action :set_todo_list, except: []
  before_action :set_todo_item, except: [:new,:create]
  ...
  def create
    ...
    respond_to do |format|
      if @todo_item.save
        ...
        format.json { render :show, status: :created, location: todo_list_todo_item_path }
      else
  ...
  def update
    respond_to do |format|
      if @todo_item.update(todo_item_params)
        ...
        format.json { render :show, status: :ok, location: todo_list_todo_item_path }
      else
